...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			xlarge: { media: '(min-width: 1281px) and (max-width: 1680px)', href: '/css/style-xlarge.css' },
			large: { media: '(min-width: 1025px) and (max-width: 1280px)', href: '/css/style-large.css', containers: '42em', grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
			medium: { media: '(max-width: 1024px)', href: '/css/style-medium.css', containers: '85%!' },
			small: { media: '(max-width: 815px)', href: '/css/style-small.css', containers: '90%!', grid: { gutters: ['1.25em', 0] } },
